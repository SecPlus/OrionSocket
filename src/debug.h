...
#   define ORION_DEBUG(x...)     fprintf(stderr,x)
#else
#   define ORION_DEBUG(x...)
#endif  /* ORION_LOG_STDERR */

#define ORION_PRINT(format, ...)   printf(format, __VA_ARGS__)
#define ORION_DEBUG_SAFE(format, x) \
        if (x) \
            ORION_DEBUG(format, x)
